    ...
    <aside className="z-50 h-100 duration-300 rounded-none side_navbar"> 
      <div className="side_nav_links_main pt-2">
        <ul className="mb-4 flex flex-col gap-1">
          <li>
            <NavLink className="side_nav_link" to={"/dashbaord/home"}>
              {({ isActive }) => (
                <Button
          ...
          <li>
            <div>
              <div
                className="flex items-center justify-between text-white gap-2 px-4 py-3 cursor-pointer side_nav_link bg-[#1d2531] text-[#b7c0cd] font-semibold"
              >
                <div className="flex items-center gap-3">
                  <span>📁</span>
                  <span className="font-medium capitalize text-white">Parent Name</span>
                </div>
                <svg xmlns="http://www.w3.org/2000/svg"
                  fill="none" viewBox="0 0 24 24"
                  stroke="currentColor"
                  className="w-4 h-4 transition-transform rotate-180 text-white">
              ...
              <ul className="ml-6 mt-1 space-y-1">
                <li>
                  <a href="/dashboard/child1"
                    className="block px-4 py-2 text-sm side_nav_link text-indigo-600 font-semibold">
                    Child Page 1
                  </a>
                </li>
                <li>
                  <a href="/dashboard/child2"
                    className="block px-4 py-2 text-sm side_nav_link text-white">
                    Child Page 2
                  </a>
                </li>
                <li>
                  <a href="/dashboard/child3"
                    className="block px-4 py-2 text-sm side_nav_link text-white">
                    Child Page 3
                  </a>
                </li>
